...
static StringArray getSpeakerArrangements()
{
    ...
    const Vst::CString arrangements[] =
    {
        ...
        kString80CubeS,             kStringAmbi1stOrderS,    kString71CineTopCenterS,
        kString71CineCenterHighS,   kString71CineFrontHighS,    kString71CineSideHighS,
        kString71CineFullRearS,     kString50S,                 kString51S,
...
static StringArray getNamedSpeakerArrangements()
{
    ...
    const Vst::CString arrangements[] =
    {
        ...
        kString81Music,     kString102,             kString122,                 kString50        kString51,          kString100,             kString101,                 kString110,
